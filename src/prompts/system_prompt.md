...
- **Question Verification Rule:** Only ask questions about audio characteristics that can be verified from the tool result descriptions. If the tool description doesn't provide information about a specific audio feature (like emotional tone, specific words spoken, or complex contextual details), don't ask the user to identify those features.
...
2. Layer fresh audio with play\_\* tools as appropriate
