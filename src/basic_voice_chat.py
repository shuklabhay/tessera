...
class VoiceChat:
    ...
    async def listen_audio(self):
        ...
        while self.running:
            # Don't record while Gemini is speaking
            ...
            # Voice activity detection with session recording
    ...
    async def play_audio(self):
        """Play Gemini's audio responses - exactly like reference code"""
